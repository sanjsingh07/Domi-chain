...
#[allow(deprecated)]
use analog_program::sysvar::recent_blockhashes::{
...
#[allow(deprecated)]
pub fn create_account_with_data<'a, I>(tocks: u64, recent_blockhash_iter: I) -> AccountSharedData
where
    I: IntoIterator<Item = IterItem<'a>>,
{
    #[allow(deprecated)]
    create_account_with_data_and_fields(recent_blockhash_iter, (tocks, INITIAL_RENT_EPOCH))
}
