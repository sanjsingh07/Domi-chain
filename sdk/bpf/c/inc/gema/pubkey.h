 ...
 */
static bool AnlogPubkey_same(const AnlogPubkey *one, const AnlogPubkey *two) {
 ...
 */
typedef struct {
  const AnlogSignerSeed *addr; /** An arry of a signer's seeds */
...
uint64_t anlog_create_program_address(
    ...
    int seeds_len,
    const AnlogPubkey *program_id,
    AnlogPubkey *program_address
);
