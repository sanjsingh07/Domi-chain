 ...
 */
void anlog_log_data(AnlogBytes *fields, uint64_t fields_len);
 ...
 */
static void anlog_log_params(const AnlogParameters *params) {
  ...
  for (int i = 0; i < params->ka_num; i++) {
    ...
    anlog_log("  - Tocks");
    anlog_log_64(0, 0, 0, 0, *params->ka[i].tocks);
    anlog_log("  - data");
