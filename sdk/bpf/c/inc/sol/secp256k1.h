#pragma once
/**
 * @brief Analog secp256k1 system call
 */
...
/** The hash provided to a anlog_secp256k1_recover is invalid */
#define SECP256K1_RECOVER_ERROR_INVALID_HASH 1
/** The recovery_id provided to a anlog_secp256k1_recover is invalid */
#define SECP256K1_RECOVER_ERROR_INVALID_RECOVERY_ID 2
/** The signature provided to a anlog_secp256k1_recover is invalid */
 ...
 */
uint64_t anlog_secp256k1_recover(
    const uint8_t *hash,
