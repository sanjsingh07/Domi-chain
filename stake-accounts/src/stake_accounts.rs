...
pub(crate) fn rebase_stake_accounts(
    ...
    balances
        .iter()
        .enumerate()
        .filter_map(|(i, (stake_account_address, tocks))| {
...
mod tests {
    ...
    fn create_bank(tocks: u64) -> (Bank, Keypair, u64) {
    ...
    fn create_account<C: SyncClient>(
        ...
        client
            .transfer_and_confirm(tocks, funding_keypair, &fee_payer_keypair.pubkey())
            .unwrap();
        fee_payer_keypair
    }
    ...
    fn test_new_derived_stake_account() {
        ...
        let tocks = rent + 1;
        let stake_authority_pubkey = analog_sdk::pubkey::new_rand();
        let withdraw_authority_pubkey = analog_sdk::pubkey::new_rand();
    ...
    fn test_authorize_stake_accounts() {
        ...
        let new_stake_authority_pubkey = analog_sdk::pubkey::new_rand();
        let new_withdraw_authority_pubkey = analog_sdk::pubkey::new_rand();
