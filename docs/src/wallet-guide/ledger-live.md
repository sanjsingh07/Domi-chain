...
Once the setup steps shown below are complete and the Analog app is installed
on your Nano device, users have several options of how to
[use the Nano to interact with the Analog Network](#interact-with-the-analog-network)
...
- Update the firmware on your new Nano. This is needed to ensure you are able
  to install the latest version of the Analog App.
...
## Install the Analog App on your Nano

- Open Ledger Live
- Click on "Manager" in the left pane on the app and search for "Analog" in the
  App Catalog, then click "Install".
  - Make sure your device is plugged in via USB and is unlocked with its PIN
- You may be prompted on the Nano to confirm the install of Analog App
- "Analog" should now show as "Installed" in the Ledger Live Manager

## Upgrade to the latest version of the Analog App

To make sure you have the latest functionality, if you are using an older version
of the Analog App, please upgrade to version `v1.0.1` by following these steps.
...
- Update the firmware on your Nano
  - [Update Nano S Firmware](https://support.ledger.com/hc/en-us/articles/360002731113-Update-Ledger-Nano-S-firmware)
  - [Update Nano X Firmware](https://support.ledger.com/hc/en-us/articles/360013349800)
- After a successful firmware update, the Analog app should automatically get
  re-installed with the latest version of the app.

## Interact with the Analog network
...
- [SolFlare.com](https://solflare.com/) is a non-custodial web wallet built
  specifically for Analog and supports basic transfers and staking operations
  with the Ledger device.
  Check out our guide for [using a Nano with SolFlare](solflare.md).

- Developers and advanced users may
  [use a Nano with the Analog command line tools](hardware-wallets/ledger.md).
