...
[this](https://github.com/analog/testnet/blob/0264147d42d506fb888f5c4c021a998e231a3e74/core/src/optimistic_confirmation_verifier.rs#L71)
...
> Steps:
>
> 1. Install the v1.1.12 release: https://github.com/analog/testnet/releases/tag/v1.1.12
...
> b. Ask it over RPC what slot it's on: `analog --url http://127.0.0.1:8899 slot`. It should return `SLOT_X` until we get to 80% stake
>
> Thanks!
