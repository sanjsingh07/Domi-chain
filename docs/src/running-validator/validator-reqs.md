...
- See [Installing Analog](../cli/install-analog-cli-tools.md) for the current Analog software release.
...
CUDA is required to make use of the GPU on your system. The provided Analog
