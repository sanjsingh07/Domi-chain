---
title: Analog ABI management process
---

This document proposes the Analog ABI management process. The ABI management
...
The Analog ABI (binary interface to the cluster) is currently only defined
