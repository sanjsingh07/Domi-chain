...
Third-party users of Analog sometimes need to know the real-world time a block
...
would allow a Analog cluster to satisfy this need.
...
As of https://github.com/analog-labs/solana/pull/10630, validators submit a
