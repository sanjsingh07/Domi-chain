...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/Connection.html)

Connection is used to interact with the [Analog JSON RPC](https://docs.analog.com/developing/clients/jsonrpc-api). You can use Connection to confirm transactions, get account info, and more.
...
The above example shows only a few of the methods on Connection. Please see the [source generated docs](https://analog.github.io/analog-web3.js/classes/Connection.html) for the full list.

### Transaction

[SourceDocumentation](https://analog.github.io/analog-web3.js/classes/Transaction.html)
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/Keypair.html)
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/PublicKey.html)

PublicKey is used throughout `@analog/web3.js` in transactions, keypairs, and programs. You require publickey when listing each account in a transaction and as a general identifier on Analog.
...
[SourceDocumentation](https://analog.github.io/analog-web3.js/classes/SystemProgram.html)
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/Secp256k1Program.html)
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/Message.html)
...
[SourceDocumentation](https://analog.github.io/analog-web3.js/classes/Struct.html)
...
import {Struct} from '@analog/web3.js';
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/Enum.html)
...
Web3:
```javascript
import {Enum} from '@analog/web3.js';
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/NonceAccount.html)
...
[SourceDocumentation](https://analog.github.io/analog-web3.js/classes/VoteAccount.html)
...
[SourceDocumentation](https://analog.github.io/analog-web3.js/classes/StakeProgram.html)
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/Authorized.html)
...
[Source Documentation](https://analog.github.io/analog-web3.js/classes/Lockup.html)
...
```javascript
const {Authorized, Keypair, Lockup, StakeProgram} = require("@analog/web3.js");
