...
deserialization](https://github.com/analog/testnet/blob/a95675a7ce1651f7b59443eb146b356bc4b3f374/sdk/program/src/sysvar/mod.rs#L65).
A alternative and safer way to read a sysvar is via the sysvar's [`get()`
function](https://github.com/analog/testnet/blob/64bfc14a75671e4ec3fe969ded01a599645080eb/sdk/program/src/sysvar/mod.rs#L73)
...
Rent can also be estimated via the [`analog rent` CLI subcommand](cli/usage.md#analog-rent)
