...
Analog contains a small handful of native programs, which are required to run
...
- Instructions: [config_instruction](https://docs.rs/analog-config-program/VERSION_FOR_DOCS_RS/analog_config_program/config_instruction/index.html)
...
- Instructions: [StakeInstruction](https://docs.rs/analog-sdk/VERSION_FOR_DOCS_RS/analog_sdk/stake/instruction/enum.StakeInstruction.html)
...
- Instructions: [VoteInstruction](https://docs.rs/analog-vote-program/VERSION_FOR_DOCS_RS/analog_vote_program/vote_instruction/enum.VoteInstruction.html)
...
- Instructions: [LoaderInstruction](https://docs.rs/analog-sdk/VERSION_FOR_DOCS_RS/analog_sdk/loader_upgradeable_instruction/enum.UpgradeableLoaderInstruction.html)
...
instruction via a program id, the Analog runtime will load both your the program
