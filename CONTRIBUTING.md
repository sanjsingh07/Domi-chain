...
then about 1,000 lines of changes is about the most you should ask a Analog
...
is ready to be integrated, the Analog maintainers will work with you to decide
...
mechanism. Draft PRs are a convenient way to collaborate with the Analog
...
Analog's architecture is described by docs generated from markdown files in
...
[Accepted Design Proposals](https://docs.analog.com/proposals/accepted-design-proposals)
section of the Analog docs.  Here's the full process:
