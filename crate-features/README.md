...
The `analog-crate-features` offers a workaround to this "feature thrashing"
...
crates in the Analog source tree should depend on `analog-crate-features`.
...
dependency of `analog-crate-features` with the union of all observed enabled
