    ...
    App::new(crate_name!())
            ...
            SubCommand::with_name("distribute-tokens")
                ...
                .arg(
                    Arg::with_name("transfer_amount")
                        ...
                        .value_name("AMOUNT")
                        .validator(is_amount)
                        .help("The amount to send to each recipient, in ANLOG"),
                )
                .arg(
        ...
        .subcommand(
            SubCommand::with_name("create-stake")
                ...
                .arg(
                    Arg::with_name("unlocked_anlog")
                        .default_value("1.0")
                        .long("unlocked-anlog")
                        .takes_value(true)
                        .value_name("ANLOG_AMOUNT")
                        .help("Amount of ANLOG to put in system account to pay for fees"),
                )
                .arg(
