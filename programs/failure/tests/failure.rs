...
use analog_runtime::loader_utils::create_invoke_instruction;
use analog_sdk::client::SyncClient;
use analog_sdk::genesis_config::create_genesis_config;
use analog_sdk::instruction::InstructionError;
...
fn test_program_native_failure() {
    ...
    bank.add_native_program("analog_failure_program", &program_id, false);
