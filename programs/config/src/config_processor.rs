...
mod tests {
    ...
    fn test_process_store_with_additional_signers() {
        ...
        let signer0_pubkey = analog_sdk::pubkey::new_rand();
        let signer1_pubkey = analog_sdk::pubkey::new_rand();
        let keys = vec![
            (pubkey, false),
            (signer0_pubkey, true),
            (signer1_pubkey, true),
    ...
    fn test_config_updates() {
        ...
        let signer0_pubkey = analog_sdk::pubkey::new_rand();
        let signer1_pubkey = analog_sdk::pubkey::new_rand();
        let signer2_pubkey = analog_sdk::pubkey::new_rand();
        let signer0_account = RefCell::new(AccountSharedData::default());
        let signer1_account = RefCell::new(AccountSharedData::default());
    ...
    fn test_config_initialize_no_panic() {
        let from_pubkey = analog_sdk::pubkey::new_rand();
        let config_pubkey = analog_sdk::pubkey::new_rand();
        let instructions =
