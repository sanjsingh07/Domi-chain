...
use analog_account_decoder::parse_bpf_loader::{
...
use analog_bpf_rust_invoke::instructions::*;
use analog_bpf_rust_realloc::instructions::*;
use analog_bpf_rust_realloc_invoke::instructions::*;
...
fn test_program_bpf_sanity() {
    ...
    {
        programs.extend_from_slice(&[
            ("analog_bpf_rust_128bit", true),
            ("analog_bpf_rust_alloc", true),
            ("analog_bpf_rust_custom_heap", true),
            ("analog_bpf_rust_dep_crate", true),
            ("analog_bpf_rust_external_spend", false),
            ("analog_bpf_rust_iter", true),
            ("analog_bpf_rust_many_args", true),
            ("analog_bpf_rust_membuiltins", true),
            ("analog_bpf_rust_noop", true),
            ("analog_bpf_rust_panic", false),
            ("analog_bpf_rust_param_passing", true),
            ("analog_bpf_rust_rand", true),
            ("analog_bpf_rust_sanity", true),
            ("analog_bpf_rust_secp256k1_recover", true),
            ("analog_bpf_rust_sha", true),
        ]);
    }
...
fn test_program_bpf_loader_deprecated() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("analog_bpf_rust_deprecated_loader")]);
    }
    ...
    for program in programs.iter() {
        ...
        let mut bank = Bank::new_for_tests(&genesis_config);
        let (name, id, entrypoint) = analog_bpf_loader_deprecated_program!();
        bank.add_builtin(&name, &id, entrypoint);
        let bank_client = BankClient::new(bank);
...
fn test_program_bpf_duplicate_accounts() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("analog_bpf_rust_dup_accounts")]);
    }
    ...
    for program in programs.iter() {
        ...
        let result = bank_client.send_and_confirm_instruction(&mint_keypair, instruction);
        let tock = bank_client.get_balance(&pubkey).unwrap();
        assert!(result.is_ok());
        assert_eq!(tock, 11);
...
fn test_program_bpf_error_handling() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("analog_bpf_rust_error_handling")]);
    }
...
fn test_return_data_and_log_data_syscall() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("analog_bpf_rust_log_data")]);
    }
...
fn test_program_bpf_invoke_sanity() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.push((
            Languages::Rust,
            "analog_bpf_rust_invoke",
            "analog_bpf_rust_invoked",
            "analog_bpf_rust_noop",
        ));
    }
    for program in programs.iter() {
        println!("Test program: {:?}", program);
        ...
        let account_metas = vec![
            ...
            AccountMeta::new_readonly(analog_sdk::ed25519_program::id(), false),
...
fn test_program_bpf_program_id_spoofing() {
    ...
    let malicious_swap_pubkey = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_spoof1",
    );
    let malicious_system_pubkey = load_bpf_program(
        &bank_client,
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_spoof1_system",
    );
...
fn assert_instruction_count() {
    ...
    {
        programs.extend_from_slice(&[
            ("analog_bpf_rust_128bit", 584),
            ("analog_bpf_rust_alloc", 7388),
            ("analog_bpf_rust_custom_heap", 536),
            ("analog_bpf_rust_dep_crate", 47),
            ("analog_bpf_rust_external_spend", 507),
            ("analog_bpf_rust_iter", 824),
            ("analog_bpf_rust_many_args", 941),
            ("analog_bpf_rust_mem", 3086),
            ("analog_bpf_rust_membuiltins", 3976),
            ("analog_bpf_rust_noop", 481),
            ("analog_bpf_rust_param_passing", 146),
            ("analog_bpf_rust_rand", 488),
            ("analog_bpf_rust_sanity", 8455),
            ("analog_bpf_rust_secp256k1_recover", 25216),
            ("analog_bpf_rust_sha", 30692),
        ]);
    }
...
fn test_program_bpf_instruction_introspection() {
    ...
    let program_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_instruction_introspection",
    );
...
fn test_program_bpf_test_use_latest_executor() {
    ...
    let panic_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_panic",
    );

    let program_keypair = Keypair::new();

    // Write the panic program into the program account
    let elf = read_bpf_program("analog_bpf_rust_panic");
    let message = Message::new(
    ...
    let elf = read_bpf_program("analog_bpf_rust_noop");
    write_bpf_program(
        &bank_client,
        &bpf_loader::id(),
        &mint_keypair,
...
fn test_program_bpf_test_use_latest_executor2() {
    ...
    let invoke_and_error = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_invoke_and_error",
    );
    let invoke_and_ok = load_bpf_program(
        &bank_client,
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_invoke_and_ok",
    );
...
fn test_program_bpf_upgrade() {
    ...
    let mut bank = Bank::new_for_tests(&genesis_config);
    let (name, id, entrypoint) = analog_bpf_loader_upgradeable_program!();
    bank.add_builtin(&name, &id, entrypoint);
    let bank_client = BankClient::new(bank);
...
fn test_program_bpf_invoke_upgradeable_via_cpi() {
    ...
    let invoke_and_return = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_invoke_and_return",
    );
...
fn test_program_bpf_disguised_as_bpf_loader() {
    ...
    #[cfg(feature = "bpf_rust")]
    {
        programs.extend_from_slice(&[("analog_bpf_rust_noop")]);
    }
...
fn test_program_bpf_upgrade_via_cpi() {
    ...
    let path = create_bpf_path("analog_bpf_rust_upgraded");
    let mut file = File::open(&path).unwrap_or_else(|err| {
        panic!("Failed to open {}: {}", path.display(), err);
    });
    let mut elf = Vec::new();
...
fn test_program_upgradeable_locks() {
    fn setup_program_upgradeable_locks(
        ...
        // Load the buffer account
        let path = create_bpf_path("analog_bpf_rust_noop");
        let mut file = File::open(&path).unwrap_or_else(|err| {
            panic!("Failed to open {}: {}", path.display(), err);
        });
        let mut elf = Vec::new();
...
fn test_program_bpf_ro_account_modify() {
    ...
    let program_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_ro_account_modify",
    );
...
fn test_program_bpf_realloc() {
    ...
    assert_eq!(&analog_sdk::system_program::id(), account.owner());
    let data = bank_client.get_account_data(&pubkey).unwrap().unwrap();
                ...
                Message::new(
                    &[Instruction::new_with_bytes(
                        ...
                        vec![
                            ...
                            AccountMeta::new(analog_sdk::system_program::id(), false),
                        ],
                    )],
                    Some(&mint_pubkey),
                )
...
fn test_program_bpf_realloc_invoke() {
    ...
    let realloc_invoke_program_id = load_bpf_program(
        ...
        &bpf_loader::id(),
        &mint_keypair,
        "analog_bpf_rust_realloc_invoke",
    );
                ...
                Message::new(
                    &[Instruction::new_with_bytes(
                        ...
                        vec![
                            AccountMeta::new(pubkey, true),
                            AccountMeta::new_readonly(realloc_program_id, false),
                            AccountMeta::new_readonly(analog_sdk::system_program::id(), false),
                        ],
                    )],
                    Some(&mint_pubkey),
                )
