...
#[deprecated(
    since = "1.8.0",
    note = "Please use `analog_sdk::stake::instruction` or `analog_program::stake::instruction` instead"
)]
...
pub fn process_instruction(
    ...
    match limited_deserialize(data)? {
        ...
        StakeInstruction::Split(tocks) => {
            ...
            me.split(tocks, split_stake, &signers)
        }
...
mod tests {
    ...
    fn test_stake_process_instruction_decode_bail() {
        ...
        bad_vote_account
            .get_mut()
            .set_owner(analog_vote_program::id());
