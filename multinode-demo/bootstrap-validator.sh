...
identity=$ANALOG_CONFIG_DIR/bootstrap-validator/identity.json
vote_account="$ANALOG_CONFIG_DIR"/bootstrap-validator/vote-account.json

ledger_dir="$ANALOG_CONFIG_DIR"/bootstrap-validator
[[ -d "$ledger_dir" ]] || {
