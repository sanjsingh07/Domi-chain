...
mod tests {
    ...
    use crate::{
        ...
        genesis_utils::{
            bootstrap_validator_stake_tocks, create_genesis_config,
    ...
    use analog_runtime::bank::Bank;
    use analog_sdk::clock::NUM_CONSECUTIVE_LEADER_SLOTS;
    use analog_sdk::epoch_schedule::{
    ...
    fn test_next_leader_slot() {
        ...
        let mut genesis_config =
            create_genesis_config_with_leader(42, &pubkey, bootstrap_validator_stake_tocks())
                .genesis_config;
        ...
        assert_eq!(
            cache.next_leader_slot(
                &analog_sdk::pubkey::new_rand(), // not in leader_schedule
                0,
                &bank,
                None,
                std::u64::MAX
    ...
    fn test_next_leader_slot_next_epoch() {
        let GenesisConfigInfo {
            ...
            mint_keypair,
            ..
        } = create_genesis_config(10_000 * bootstrap_validator_stake_tocks());
        genesis_config.epoch_schedule.warmup = false;
    ...
    fn test_schedule_for_unconfirmed_epoch() {
        ...
        let bank2 = Bank::new_from_parent(&bank, &analog_sdk::pubkey::new_rand(), 95);
