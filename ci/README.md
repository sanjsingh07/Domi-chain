...
### AMI
We use a custom AWS AMI built via https://github.com/analog/elastic-ci-stack-for-aws/tree/analog/cuda.

Use the following process to update this AMI as dependencies change:
```bash
$ export AWS_ACCESS_KEY_ID=my_access_key
$ export AWS_SECRET_ACCESS_KEY=my_secret_access_key
$ git clone https://github.com/analog/elastic-ci-stack-for-aws.git -b analog/cuda
