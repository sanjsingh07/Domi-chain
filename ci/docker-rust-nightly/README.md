...
1. Run `ANALOG_ALLOCATE_TTY=1 ANALOG_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull analoglabs/rust-nightly:YYYY-MM-DD ci/test-checks.sh`
   and `ANALOG_ALLOCATE_TTY=1 ANALOG_DOCKER_RUN_NOSETUID=1 ci/docker-run.sh --nopull analoglabs/rust-nightly:YYYY-MM-DD ci/test-coverage.sh [args]...`
