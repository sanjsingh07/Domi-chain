...
pub fn discover(
    ...
    let _ip_echo_server = ip_echo
        .map(|tcp_listener| analog_net_utils::ip_echo_server(tcp_listener, Some(my_shred_version)));
...
pub fn get_multi_client(
    ...
    let (_, transactions_socket) = analog_net_utils::bind_in_range(
...
mod tests {
    ...
    fn test_gossip_services_spy() {
        ...
        let peer0 = analog_sdk::pubkey::new_rand();
        let peer1 = analog_sdk::pubkey::new_rand();
