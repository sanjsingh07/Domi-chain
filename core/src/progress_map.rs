use {
    ...
    analog_ledger::blockstore_processor::{ConfirmationProgress, ConfirmationTiming},
    analog_runtime::{bank::Bank, bank_forks::BankForks, vote_account::VoteAccount},
    analog_sdk::{clock::Slot, hash::Hash, pubkey::Pubkey},
    std::{
...
mod test {
    ...
    fn test_add_vote_pubkey() {
        ...
        let mut vote_pubkey = analog_sdk::pubkey::new_rand();
        ...
        vote_pubkey = analog_sdk::pubkey::new_rand();
    ...
    fn test_add_node_pubkey_internal() {
        ...
        let vote_account_pubkeys: Vec<_> = std::iter::repeat_with(analog_sdk::pubkey::new_rand)
        ...
        let mut stats = PropagatedStats::default();
        let mut node_pubkey = analog_sdk::pubkey::new_rand();
