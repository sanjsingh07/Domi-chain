...
use analog_ledger::blockstore::{Blockstore, PurgeType};
use analog_ledger::blockstore_db::Result as BlockstoreResult;
use analog_measure::measure::Measure;
use analog_sdk::clock::{Slot, DEFAULT_TICKS_PER_SLOT, TICKS_PER_DAY};
...
impl LedgerCleanupService {
    pub fn new(
        ...
        let t_cleanup = Builder::new()
            .name("anlog-led-cleanup".to_string())
            .spawn(move || loop {
        ...
        let t_compact = Builder::new()
            .name("anlog-led-compact".to_string())
            .spawn(move || loop {
        ...
        *last_purge_slot = root;
        ...
        if slots_to_clean {
            ...
            let _t_purge = Builder::new()
                .name("analog-ledger-purge".to_string())
                .spawn(move || {
...
mod tests {
    use super::*;
    use analog_ledger::blockstore::make_many_slot_entries;
