use analog_client::{pubsub_client::PubsubClient, rpc_client::RpcClient, rpc_response::SlotInfo};
...
fn test_rpc_client() {
    ...
    let tx = system_transaction::transfer(&alice, &bob_pubkey, anlog_to_tocks(20.0), blockhash);
    ...
    assert_eq!(
        ...
        original_alice_balance - anlog_to_tocks(20.0)
    );
}
