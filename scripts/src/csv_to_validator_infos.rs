...
//
// Usage:
//   cargo run --bin analog-csv-to-validator-infos < validators.csv
...
fn parse_csv() -> Result<(), Box<dyn Error>> {
    ...
    for result in rdr.deserialize() {
        ...
        println!(
            r#"ValidatorInfo {{name: "{adjective} {noun}", node: "{identity_pubkey}", node_anlog: {tokens:.1}, vote: "{vote_pubkey}", commission: 0}},"#,
