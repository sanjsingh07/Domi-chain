# |source| this file
#
# The ANALOG_METRICS_CONFIG environment variable is formatted as a
# comma-delimited list of parameters. All parameters are optional.
#
# Example:
#   export ANALOG_METRICS_CONFIG="host=<metrics host>,db=<database name>,u=<username>,p=<password>"
#
...
configureMetrics() {
  [[ -n $ANALOG_METRICS_CONFIG ]] || return 0

  declare metricsParams
  IFS=',' read -r -a metricsParams <<< "$ANALOG_METRICS_CONFIG"
